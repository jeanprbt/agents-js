...
//
// Speculative port of the survey agent onto the proposed JS-ification
// composition API. `defineAgentTask` and `createComposable` below reflect
// the RFC sketch — neither is a landed API yet.
import {
  type JobContext,
  type Signal,
  beta,
